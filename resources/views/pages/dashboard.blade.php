            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Enquiry phone Followup</h4>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex justify-content-center align-items-center">
                                            <div class="flex-grow-1">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Never
                                                    Contacted</span>
                                                <h4 class="mb-3">
                                                    <span class="counter-value text-danger" data-target="1256">0</span>
                                                </h4>
                                                <div class="text-nowrap">
                                                    <span class="badge bg-danger-subtle text-dark">pending</span>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Normal</span>
                                                <h4 class="mb-3">
                                                    <span class="counter-value text-danger" data-target="1256">0</span>
                                                </h4>
                                                <div class="text-nowrap">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate">RTB</span>
                                                <h4 class="mb-3">
                                                    <span class="counter-value text-danger" data-target="1256">0</span>
                                                </h4>
                                                <div class="text-nowrap">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate"> > 90 Days</span>
                                                <h4 class="mb-3">
                                                    <span class="counter-value text-danger" data-target="1256">0</span>
                                                </h4>
                                                <div class="text-nowrap">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Normal</span>
                                                <h4 class="mb-3">
                                                    <span class="counter-value text-warning" data-target="1256">0</span>
                                                </h4>
                                                <div class="text-nowrap">
                                                    <span class="badge bg-warning-subtle text-dark">Today</span>
                                                    {{-- <span class="ms-1 text-muted font-size-13">Since last week</span> --}}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Normal</span>
                                                <h4 class="mb-3">
                                                    <span class="counter-value text-success" data-target="1256">0</span>
                                                </h4>
                                                <div class="text-nowrap">
                                                    <span class="badge bg-success-subtle text-dark">Today</span>
                                                    {{-- <span class="ms-1 text-muted font-size-13">Since last week</span> --}}
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    <span class="text-muted mb-3 lh-1 d-block text-truncate"> > 90 Days
                                        old</span>
                                    <h4 class="mb-3">
                                        ...
                                        <table class="table align-middle table-nowrap">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="mb-1"><a href="" class="text-dark">Out
                                                                Of Stock</a></p>
