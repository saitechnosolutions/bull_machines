                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Permission Assign</li>
                            </ol>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-5">
                    <div class="card card-h-50">
                        <!-- card body -->
                        <div class="card-body">
                            <form action="" method="post" id="permission_assign_form" data-url="">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mt-3">
                                            <label for="select_assign_role">Choose Role</label>
                                            <select class="form-select" aria-label="Default select example"
                                                id="select_assign_role">
                                        ...
                                        <div class="mt-3">
                                            <label for="select_assign_permission">Choose Permission</label>
                                            {{-- <input type="text" class="form-control" id="select_assign_permission"
                                                placeholder="Enter Permission name" name="master_permission_name"> --}}
                                            <select class="form-select" aria-label="Default select example"
                                                id="select_assign_permission">
                                                <option selected>Open this select menu</option>
