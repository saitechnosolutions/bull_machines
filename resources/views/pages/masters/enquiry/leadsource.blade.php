            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">LeadSource Master</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Enquiry</a></li>
                                <li class="breadcrumb-item active">LeadSource</li>
                            </ol>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-5">
                    <div class="card card-h-50">
                        <!-- card body -->
                        <div class="card-body">
                            <form action="" method="post" id="leadsource_add_form" data-url="">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mt-3">
                                            <label for="input-master_leadsource_name">LeadSource Name</label>
                                            <input type="text" class="form-control" id="input-master_leadsource_name"
                                                placeholder="Enter LeadSource Name" name="master_leadsource_name">
                                        </div>
                            ...
                            <form action="" method="post" id="leadsource_edit_form" data-url="">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mt-3">
                                            <label for="edit-master_leadsource_name">LeadSource Name</label>
                                            <input type="text" class="form-control" id="edit-master_leadsource_name"
                                                placeholder="Enter Horsepower" name="edit_master_leadsource_name">
                                            <input type="hidden" name="" id="edit-leadsource_id">
                                        </div>
...
@section('scripts')
    <script>
        const validator = new window.JustValidate("#leadsource_add_form");
        ...
        const editvalidator = new window.JustValidate("#leadsource_edit_form");
